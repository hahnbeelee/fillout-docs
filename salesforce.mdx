...
<Steps>
  ...
  <Step title="Map your form fields">
    ...
    <Tip>
      To [update your Fillout form](https://www.fillout.com/help/additional-integration-mappings#updating-fields-and-options) after editing your Salesforce object, click <Icon icon="arrows-rotate" size={12} /> on the left-hand panel.
    </Tip>
