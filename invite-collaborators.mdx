...
<CardGroup cols={3}>
  ...
  <Card title="Import and export forms" icon="folder-open" iconType="regular" color="#FFC738" href="/importing-and-exporting-forms">
    Transfer between different Fillout accounts.
  </Card>
  <Card title="Add a comment" icon="comment-dots" iconType="regular" color="#FFC738" href="/comment">
    Comment on submissions and tag your teammates.
  </Card>
</CardGroup>