...
<Steps>
  ...
  <Step title="Publish and share">
    That's it! Click `Update` on the upper right corner.
    ...
    Then, `Publish` your form to reflect the changes. To update a record after publishing, click one of the unique links from Monday.
