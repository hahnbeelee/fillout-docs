...
<Steps>
  <Step title="Start with a workflow">
    Click `Integrate` on the top menu of your form, followed by `Workflows`. Then, choose a template under **Notifications**. Alternatively, you may open a form and go to its **Settings** page followed by **Custom emails**.
  ...
  <Step title="Edit your email">
    ...
    Edit the **Subject**, add **Attachments**, choose where to **Send email from**, and more. You can also opt to `Send from your own email +` account.
