...
<Steps>
  <Step title="Start with a workflow">
    Go to **Integrate** from the top menu of your form, and click `Workflows`. Then, choose a template under **Notifications**. Alternatively, you may open a form and go to its **Settings** followed by **Custom emails**.
