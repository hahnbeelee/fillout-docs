...
<Steps>
  ...
  <Step title="Link forms">
    Click the field's <Icon icon="gear" iconType="solid" /> to open the right-hand panel. Choose a **Connected Subform** to link another form, which will open as a popup for respondents. Then, select a \*\*Main Field \*\*to label each subform entry.
