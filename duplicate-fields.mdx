...
Click and drag to highlight the fields you want to copy. Alternatively, you can hold `Shift` and click the fields you'd like to move. Then, click the `move fields` icon and select a page to move them to.
