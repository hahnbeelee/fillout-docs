...
Click the banner's <Icon icon="gear" iconType="solid" /> to change its color and icon. The right-hand panel will appear where you can select the appropriate **Alert type**.
