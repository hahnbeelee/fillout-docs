...
<Steps>
  ...
  <Step title="Connect your database to your form">
    ...
    <Info>
      Don’t see your table in the dropdown list? Check you have connected to the correct base, and try refreshing the page or hitting the refresh icon.
    </Info>
  </Step>
  <Step title="Map your questions">
    ...
    <Tip>
      If you make changes in your Airtable base that you want to reflect in your Fillout form, hit the Refresh icon <Icon icon="arrows-rotate" color="#064e3b" /> , or refresh the Fillout page
    </Tip>
  </Step>
