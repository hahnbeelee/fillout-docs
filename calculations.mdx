...
<Steps>
  ...
  <Step title="Define rules">
    ...
    ![Screenshot 2025-11-25 at 7.36.33 PM.png](/images/Screenshot2025-11-25at7.36.33PM.png)

    ![Screenshot 2025-11-26 at 11.48.53 AM.png](/images/Screenshot2025-11-26at11.48.53AM.png)
    ...
    Our operation will be multiplying the quantity (initial value) by the price of the dish, which is "\$6".
...
When making a new calculation, choose `duration` as the type and make your selections in the dropdown menus.
