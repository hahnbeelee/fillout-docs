...
For questions where respondents choose from a set list of options rather than typing their answers, use checkboxes, a multi-select or a picture choice field. More info [here](/multiple-option-answers).

## Related articles

<CardGroup cols={3}>
  <Card title="Multiple option answers" icon="list-check" iconType="regular" color="#FFC738" href="/multiple-option-answers">
