...
<Steps>
  ...
  <Step title="Use logic">
    Now, we'll make the form adapt based on their answer. Click a supporting field followed by its <Icon icon="gear" iconType="solid" />, then go to **Logic** in the right sidebar.
