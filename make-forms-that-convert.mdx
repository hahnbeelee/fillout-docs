...
<CardGroup cols={2}>
  <Card title="Enrich leads" icon="circle-up" iconType="regular" color="#FFC738" href="/lead-enrichment">
  ...
  <Card title="Validate emails" icon="envelope-circle-check" iconType="regular" color="#FFC738" href="/email-validation">
