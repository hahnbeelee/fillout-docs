...
Click the text field followed by its <Icon icon="gear" iconType="solid" /> to open the right-hand panel. Then, type your **Placeholder**.

![Screenshot 2025-08-15 at 3.33.01 PM.png](/images/Screenshot2025-08-15at3.33.01PM.png)

## Add placeholders to choice fields

Similar to the step above, click the field followed by its <Icon icon="gear" iconType="solid" /> to show the right-hand panel. Then, type your **Placeholder**.
