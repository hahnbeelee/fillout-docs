...
<Steps>
  ...
  <Step title="Publish and share">
    That's it! Click `Update` in the upper right corner. Then, Try out your form in `Preview`. Your form is **automatically pre-filled** for whichever record it is updating. This can be changed in the top right area.

    ![Screenshot 2025-11-10 at 10.55.06 AM.png](/images/Screenshot2025-11-10at10.55.06AM.png)

    When everything's all good, `Publish` your form to reflect the changes. To update a record after publishing, click one of the unique links from Airtable.
