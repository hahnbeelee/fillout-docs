...
<CardGroup cols={3}>
  <Card title="Pick Airtable linked records in a dropdown" icon="square-caret-down" iconType="regular" color="#FFC738" href="/select-linked-airtable-records">
    Make a linked record picker in Fillout and filter records.
  </Card>
  <Card title="Use URL parameters in embeds" icon="brackets-square" iconType="regular" color="#FFC738" href="/embedded-url-parameters">
