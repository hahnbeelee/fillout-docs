...
<Note>
  If you aren’t using a list details block, skip ahead to custom code block.
</Note>

<Steps>
  <Step title="Create a list details block">
...
## Advanced: Filtering records and access the logged in Softr user
