...
Scroll down on the left-hand panel of your form and click the `HTML` field. Then, click its <Icon icon="gear" iconType="solid" /> to `Edit HTML` and `Edit CSS` in the right-hand panel.
