...
<Steps>
  <Step title="Connect to your SmartSuite account">
    ...
    Your **workspace ID** is the first 8 characters after https://app.smartsuite.com when you’re logged in.
  ...
  <Step title="Pick your Solution and App">
    Pick a **Solution** and **App** you’d like records to be either created or updated in and `Finish setup`.
