...
<Steps>
  ...
  <Step title="Configure event details">
    On the left-hand panel, edit the details as you see fit. You can also customize avatars or use a generic image such as a company logo for the event to maintain brand consistency by clicking `Booking page` on top.
