...
<Steps>
  ...
  <Step title="Edit the contents of your email">
    Click `Set recipients` at the lower left of the popup to enter emails of the people whom you would like to send the form to. You can also edit the default email and [style](https://www.fillout.com/help/custom-emails#how-to-send-a-custom-email) it.
