...
<img
  src="/images/account/image-17.png"
...
Click `⋮` or the three vertical dots of a form and select `Move to`. Then, choose the workspace you’d like to add the form to.

![Add a form to a workspace](/images/workspace_move.png)
