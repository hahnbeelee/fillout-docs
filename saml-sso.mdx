...
<Steps>
  <Step title="Go to Settings">
    From your Fillout Dashboard and click your `Account name` followed by `Settings`.  In the **SSO** section, click `Configure SSO`. You will be guided through the setup process.
  </Step>
  ...
  <Step title="Save">
    Save the changes. At this point, you can set the default roles for newly provisioned users.
  </Step>
</Steps>
