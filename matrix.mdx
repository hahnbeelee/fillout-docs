...
<Steps>
  ...
  <Step title="Turn radio buttons into checkboxes (Optional)">
    You can configure the choice matrix to allow single or multiple selections. Click the choice matrix followed by its <Icon icon="gear" iconType="solid" />, and toggle `Can select multiple?`  in the right-hand panel.
