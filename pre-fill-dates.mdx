...
Click your date field field followed by its <Icon icon="gear-complex" iconType="solid" /> to open the right-hand panel. Under **Default value**,  click <Icon icon="square-plus" iconType="solid" /> to add a reference.
