...
<Update label="January 2026" tags={["Zite"]}>
  ## Zite Launch Week Day 4: MCP & Integrations
...
<Update label="January 2026" tags={["Zite"]}>
  ## Zite Launch Week Day 3: Workflows 2.0
...
<Update label="January 2026" tags={["Zite"]}>
  ## Zite Launch Week Day 2: Plan Mode
...
<Update label="January 2026" tags={["Zite"]}>
  ## Zite Launch Week Day 1: Building experience upgrades
...
<Update label="November 2025" tags={["Forms", "Zite",]}>
  ...
  Powered by Postgres under the hood, Zite Database has SQL-level speed and rate limits (50+ req/sec). Ideal for high throughput form and app use cases.
