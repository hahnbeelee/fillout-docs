...
#### 🆓 Free error fixes
  ...
  You can now choose from three AI models in the Zite editor:
  ...
  After each message, you can now see exactly how many credits were used. Click on any message to view the model used and credits consumed.
